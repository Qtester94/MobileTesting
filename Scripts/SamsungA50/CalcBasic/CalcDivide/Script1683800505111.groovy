...
Mobile.tap(findTestObject('SamsungA50/Calc/android.widget.Button - 6'), 0)

Mobile.tap(findTestObject('SamsungA50/Calc/android.widget.Button - 2'), 0)

Mobile.tap(findTestObject('SamsungA50/Calc/android.widget.Button - 0'), 0)

Mobile.tap(findTestObject('SamsungA50/Calc/android.widget.Button - 0'), 0)

Mobile.tap(findTestObject('SamsungA50/Calc/android.widget.ButtonDivide'), 0)
...
Mobile.verifyElementText(findTestObject('SamsungA50/Calc/android.widget.EditText - 450 Calculation result'), '450 Calculation result')
