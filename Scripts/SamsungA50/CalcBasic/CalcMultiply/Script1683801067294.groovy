...
Mobile.tap(findTestObject('SamsungA50/Calc/android.widget.Button - 5'), 0)

Mobile.tap(findTestObject('SamsungA50/Calc/android.widget.ButtonMultiply'), 0)
...
Mobile.verifyElementText(findTestObject('SamsungA50/Calc/android.widget.EditText - 1,495 Calculation result'), '1,495 Calculation result')
